 ...
 */
export const SelectSearchInput: React.FC<SelectSearchInputProps> = ({ value, onChange, placeholder }) => {
  return (
    <div className="uci-px-2 uci-mb-1">
      <div className="uci-relative">
  <span className="uci-absolute uci-inset-y-0 uci-left-2 uci-text-[#666] uci-flex uci-items-center" aria-hidden="true">
          <SearchIcon />
        </span>
        <input
          type="text"
